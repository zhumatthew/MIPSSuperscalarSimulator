...
SimulatedInstruction::SimulatedInstruction() : originalString("NOP"), opcode(opcode_nop), rd(0), rs(0), rt(0), rdValue(0), rtValue(0), rsValue(0), immediate(0), funct(funct_sll), shamt(0), opcodeString("NOP"), currentForward(Forwarding()), effectiveAddress(0), branchCondition(false), reordered(false), instructionLocation(0), loopCount(0) {}
